...
file_path = 'AIDM_Lab2-A2.4/aw_fb_data.csv'
...
plt.savefig('AIDM_Lab2-A2.4/calories_histogram.png') # Save the histogram 
...
plt.xlabel('Calories')
plt.ylabel('Frequency')
plt.savefig('AIDM_Lab2-A2.4/calories_log_histogram.png') # Save the log plot
## plt.show() # Display the plot
...
# Cube root transform, github copilot suggestions
...
plt.savefig('AIDM_Lab2-A2.4/calories_cube_histogram.png') # Save the cube plot
## plt.show() # Display the plot
